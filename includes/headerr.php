...
<?php
    if (isset($_SESSION["id_usuario"])){
        $img = $u->buscarDados($_SESSION["id_usuario"]);
        var_dump($img);
?>
                    ...
                    <div>
                        <div class="row">
                            <div class=" col s2">
                                <li>
                                    <a href="login.php">
                                        <img src="image/user.jpg" alt="" class="circle responsive-img">
                                    </a>
                                </li>
                            </div>
                        </div>
    ...
    <ul class="sidenav white" id="mobile-demo"><br>
        <div>
            <div class="row center-align">
                <div class=" col s4">
                    <li><img src="image/user.jpg" alt="" class="circle responsive-img"></li>
